<template>
  ...
  <div class="input-msg" :class="{ 'input-msg-select':showEmojiPicker}">
    ...
    <textarea @click="clickTextArea" ref="textarea" @focus="getFocus()" v-model="inputMsg" @keydown.enter.prevent="sendMessage" placeholder="输入..."></textarea>
...
export default {
  ...
  methods: {
    ...
    sendMessage(){
      this.$emit('sendMessageFunc', this.inputMsg)
    }
  }
