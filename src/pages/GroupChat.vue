...
//    TextareaEmojiPicker ,
    ...
    addEmoji (emoji) {
      ...
      const cursorPosition = this.currentPosition || textarea.selectionEnd;
      console.log(cursorPosition, textarea.selectionEnd, '-=-=-=-=-')
...
//      textarea.focus();
      this.$nextTick(() => {
        ...
        console.log(textarea.selectionEnd, '9999999999999999999')
        this.currentPosition = textarea.selectionEnd;
      })
    },
		//获取聊天记录
		getChatMsg() {
